...
export default function VideoBackground() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center px-4 z-[60]">
        <div
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center text-center max-w-2xl mx-auto">
            <img
              className="h-48 max-w-[80%] md:max-w-full w-auto object-contain drop-shadow-[0_0_15px_rgba(0,0,0,0.5)] z-[60]"
              src="madagabot.png"
              alt="Madagabot Logo"
            />
